...
var smeankbn2 = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( smeankbn2 instanceof Error )
};
...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof smeankbn2, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 1', opts, function test( t ) {
	t.strictEqual( smeankbn2.length, 1, 'has expected arity' );
	t.end();
});
